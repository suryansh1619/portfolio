    ...
    return (
        <section    
            ...
            <h2 
                ...
                style={{color:!darktheme ? 'var(--title-color)':'var(--container-color)'}}><span>A</span>bout <span>Me</span></h2>
            <h4 
                className="section-subtitle"
                style={{color:!darktheme ? 'var(--title-color)':'var(--container-color)'}}>My Introduction</h4>
